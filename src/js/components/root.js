        ...
        <Route exact path="/~bitcoin" render={ () => {
          return (
            <div className="cf w-100 flex flex-column pa4 ba-m ba-l ba-xl b--gray2 br1 h-100 h-100-minus-40-m h-100-minus-40-l h-100-minus-40-xl f9 white-d">
              <h1 className="mt0 f8 fw4">bitcoin</h1>
              <p className="lh-copy measure pt3">Welcome to your Landscape application.</p>
              <p className="lh-copy measure pt3">To get started, edit <code>src/index.js</code> or <code>bitcoin.hoon</code> and <code>|commit %home</code> on your Urbit ship to see your changes.</p>
