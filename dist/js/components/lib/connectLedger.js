  ...
  render() {
    ...
    return (
      React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 47}}
        , React.createElement('p', { className: "f8 mt3 lh-copy db"   , __self: this, __source: {fileName: _jsxFileName, lineNumber: 48}}, "Ledger")
        , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}
         , React.createElement('div', { className: "cf w-30 fl pr2 overflow-x-hidden bg-gray0-d white-d flex flex-column"        , __self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}
            , React.createElement('button', {
              onClick: deriveXPubKey,
              className: createClasses, __self: this, __source: {fileName: _jsxFileName, lineNumber: 51}}
              ,  (state.connected) ? "Generating key": "Connect"
            )
          )
          , React.createElement('div', { className: "cf w-70 fl pr2 overflow-x-hidden bg-gray0-d white-d flex flex-column"        , __self: this, __source: {fileName: _jsxFileName, lineNumber: 57}}
            , React.createElement('textarea', {
              ...
              onChange: this.setLedgerAccount, __self: this, __source: {fileName: _jsxFileName, lineNumber: 58}}
            )
          )
        )
      )
