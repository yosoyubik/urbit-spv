...
gulp.task('css-bundle', function() {
  ...
  return gulp
    ...
    .pipe(gulp.dest('./urbit/app/bitcoin/css'));
});
...
gulp.task('js-imports', function(cb) {
  return gulp.src('dist/index.js')
    ...
    .pipe(gulp.dest('./urbit/app/bitcoin/js/'))
    .on('end', cb);
});
...
gulp.task('js-minify', function () {
  return gulp.src('./urbit/app/bitcoin/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/bitcoin/js/'));
});

gulp.task('tile-js-minify', function () {
  return gulp.src('./urbit/app/bitcoin/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/bitcoin/js/'));
});
