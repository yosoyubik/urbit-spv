const _jsxFileName = "/Users/jose/urbit/btc-landscape/src/js/indigo-react/components/Typography.js";import React from 'react';
import cn from 'classnames';

const typeWith = (DefaultComponent, defaultClassName) =>
  function({ as: As = DefaultComponent, className, ...rest }) {
    return React.createElement(As, { className: cn(defaultClassName, className), ...rest, __self: this, __source: {fileName: _jsxFileName, lineNumber: 6}} );
  };
